...
class CaptureCameraViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        sessionQueue.async {
            ...
            case .notAuthorized:
                DispatchQueue.main.async {
                    let changePrivacySetting = "OTTAR doesn't have permission to use the camera, please change privacy settings"
                    let message = NSLocalizedString(changePrivacySetting, comment: "Alert message when the user has denied access to the camera")
                    let alertController = UIAlertController(title: "OTTAR", message: message, preferredStyle: .alert)
